...
By the default the template creates a single `HelloWorld` contract under verify_medical_ai folder in the `smart_contracts` directory. To add a new contract:
